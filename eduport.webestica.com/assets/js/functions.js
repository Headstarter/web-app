...
var e = {
    ...
    darkMode: function () {
        ...
        var changeThemeToDark = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', '/theme/css/style-dark-rtl.css');
          } else {
              style.setAttribute('href', '/theme/css/style-dark.css');
          }
        ...
        var changeThemeToLight = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', '/theme/css/style-rtl.css');
          } else {
              style.setAttribute('href', '/theme/css/style.css');
          }
